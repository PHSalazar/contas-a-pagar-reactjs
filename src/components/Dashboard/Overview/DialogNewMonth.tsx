  ...
  return (
                ...
                <DialogContent>
                    <AlertDialogHeader>
                        ...
                        <DialogDescription>
                            Aqui você adiciona um novo mês ao seu planejamento. Após a crição, você pode adicionar contas ao mês que foi criado.
                        </DialogDescription>
                        <Separator />

                        <Input type='month' className='my-6'/>
                        ...
                        </AlertDialogHeader></DialogContent></Dialog>
  )
}
